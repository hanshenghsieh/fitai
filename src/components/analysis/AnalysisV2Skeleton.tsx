export default function AnalysisV2Skeleton() {
  return (
    <div className="v2-analysis-page animate-pulse">
      <div className="app-tab-header-skeleton app-tab-column mx-auto rounded-2xl bg-white/60" />
      <div className="v2-analysis-inner app-tab-page-content app-tab-column space-y-4">
