...
export default function SettingsV2Screen({ access, appVersion }: Props) {
  ...
  const nav = (path: string) => navigateTo(path, target => router.push(target))
  ...
  return (
    <V2PageEnter>
      <div
        className="v2-settings-page max-w-[640px] mx-auto pb-[28px]"
        style={{ paddingLeft: 20, paddingRight: 20 }}
      >
        <header
          className="text-center app-page-top pb-5"
        >
