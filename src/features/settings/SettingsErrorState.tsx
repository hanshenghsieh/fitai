...
export default function SettingsErrorState({ onRetry }: Props) {
  return (
    <div
      className="v2-settings-page min-h-[60vh] flex flex-col items-center justify-center px-8 text-center"
