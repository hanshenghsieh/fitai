...
export const RESTAURANT_PLACES: RestaurantPlace[] = [
  ...
  { id: 'sub-banqiao', brand: 'Subway', name: 'Subway 板橋店', lat: 25.013, lng: 121.464, address: '新北市板橋區' },
  { id: 'sushi-xinyi', brand: '爭鮮迴轉壽司', name: '爭鮮迴轉壽司 信義店', lat: 25.0345, lng: 121.563, address: '台北市信義區' },
  { id: 'sushi-plus-nanjing', brand: '爭鮮PLUS', name: '爭鮮PLUS 南京店', lat: 25.052, lng: 121.544, address: '台北市中山區' },
  { id: 'dds-taipei', brand: '點點心', name: '點點心 台北站前店', lat: 25.046, lng: 121.517, address: '台北市中正區' },
  { id: 'dds-xinyi', brand: '點點心', name: '點點心 信義店', lat: 25.033, lng: 121.566, address: '台北市信義區' },
  { id: 'skm-a11', brand: '新光三越美食街', name: '新光三越 A11 美食街', lat: 25.036, lng: 121.567, address: '台北市信義區松壽路11號' },
  { id: 'breeze-center', brand: '微風廣場美食街', name: '微風廣場 美食街', lat: 25.041, lng: 121.544, address: '台北市松山區市民大道' },
  { id: 'sogo-zhongxiao', brand: 'SOGO美食街', name: 'SOGO 忠孝館 美食街', lat: 25.0415, lng: 121.545, address: '台北市大安區忠孝東路' },
  { id: 'qsquare', brand: '京站美食街', name: '京站時尚廣場 美食街', lat: 25.047, lng: 121.517, address: '台北市中正區忠孝西路' },
  { id: 'fe21-banqiao', brand: '遠東百貨美食街', name: '遠東百貨 板橋店 美食街', lat: 25.014, lng: 121.465, address: '新北市板橋區' },
  { id: 'att4fun', brand: '誠品生活美食街', name: '誠品生活 松菸店 美食街', lat: 25.043, lng: 121.558, address: '台北市信義區松菸路' },
