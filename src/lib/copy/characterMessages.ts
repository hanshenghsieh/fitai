...
export const CHARACTER_MESSAGES: Record<MessageCategory, CharacterMessage[]> = {
  ...
  cheatMeal: [
  { id: 'cheatMeal-01', text: '聚餐？去啊。', subtext: '人生又不是只有雞胸肉。明天繼續就好。', expression: 'cheat', category: 'cheatMeal' },
  ...
  afterOvereating: [
  { id: 'afterOvereating-01', text: '昨天再賤一點。', subtext: '今天繼續好節奏。', expression: 'normal', category: 'afterOvereating' },
  ...
  { id: 'familyDinner-09', text: '家庭日。', subtext: '享受，明天繼續就好。', expression: 'normal', category: 'familyDinner' },
  ...
  success: [
  { id: 'success-01', text: '很好。', subtext: '今天沒有再胖一點。節奏還在。', expression: 'proud', category: 'success' },
  ...
  { id: 'randomThoughts-08', text: '突然。', subtext: '好一點，不是狠一點。', expression: 'normal', category: 'randomThoughts' },
