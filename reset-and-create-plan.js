...
async function resetAndCreate() {
  ...
  console.log('🗑️  Deleting all plans...');
  await fetch(
  ...
  console.log('📅 Creating plan for week starting:', weekStartStr);
  ...
  if (createRes.ok) {
    ...
    console.log('🔗 Now reload dashboard: http://localhost:3000/dashboard');
  } else {
