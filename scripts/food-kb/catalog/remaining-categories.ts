...
export const BBQ_CATALOG: BrandCatalog = {
  'yakiniku-like': [
    ...
    side('白飯（一碗）', 280, 6, 58, 0, { role: 'carb' }),
    side('味噌湯', 40, 3, 4, 25),
    side('韓式泡菜', 30, 1, 6, 20),
  ],
  kanpai: [
...
export const BUBBLETEA_EXTRA_CATALOG: BrandCatalog = {
  dezheng: [
    ...
    drink({ name: '檸檬紅茶（大杯）', calories: 180, protein_g: 1, carbs_g: 45, price: 50, tags: ['bubble_tea'] }),
  ],
  guiji: [
    drink({ name: '翡翠檸檬（大杯）', calories: 170, protein_g: 1, carbs_g: 42, price: 55, tags: ['bubble_tea'] }),
  ...
  wanpo: [
    drink({ name: '紅玉鮮奶茶（大杯）', calories: 350, protein_g: 1, carbs_g: 48, price: 58, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 410, protein_g: 1, carbs_g: 66, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '烏龍鮮奶茶（大杯）', calories: 340, protein_g: 1, carbs_g: 46, price: 58, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 30, tags: ['bubble_tea'] }),
    drink({ name: '檸檬翡翠（大杯）', calories: 175, protein_g: 1, carbs_g: 44, price: 52, tags: ['bubble_tea'] }),
  ],
  zhenzhu: [
    drink({ name: '黑糖珍珠鮮奶（大杯）', calories: 420, protein_g: 1, carbs_g: 52, price: 68, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 400, protein_g: 1, carbs_g: 64, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '黑糖珍珠紅茶（大杯）', calories: 380, protein_g: 1, carbs_g: 58, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
  ],
  comebuy: [
    drink({ name: '玩火奶茶（大杯）', calories: 420, protein_g: 1, carbs_g: 66, price: 60, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 400, protein_g: 1, carbs_g: 64, price: 55, tags: ['bubble_tea'] }),
  ...
  xianhe: [
    ...
    drink({ name: '紅茶拿鐵（大杯）', calories: 285, protein_g: 1, carbs_g: 38, price: 60, tags: ['bubble_tea'] }),
    drink({ name: '翡翠檸檬（大杯）', calories: 170, protein_g: 1, carbs_g: 42, price: 52, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
  ],
  teapost: [
    drink({ name: '珍珠奶茶（大杯）', calories: 400, protein_g: 1, carbs_g: 64, price: 50, tags: ['bubble_tea'] }),
    drink({ name: '紅茶拿鐵（大杯）', calories: 280, protein_g: 1, carbs_g: 38, price: 58, tags: ['bubble_tea'] }),
    drink({ name: '綠茶拿鐵（大杯）', calories: 275, protein_g: 1, carbs_g: 36, price: 58, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
  ],
  laolai: [
    drink({ name: '珍珠奶茶（大杯）', calories: 410, protein_g: 1, carbs_g: 66, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '冬瓜檸檬（大杯）', calories: 160, protein_g: 1, carbs_g: 40, price: 45, tags: ['bubble_tea'] }),
    drink({ name: '紅茶拿鐵（大杯）', calories: 290, protein_g: 1, carbs_g: 40, price: 62, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
  ],
  'yayoi-tea': [
    drink({ name: '八曜和茶（中杯）', calories: 8, protein_g: 1, carbs_g: 2, price: 40, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 390, protein_g: 1, carbs_g: 62, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '紅茶拿鐵（大杯）', calories: 285, protein_g: 1, carbs_g: 38, price: 62, tags: ['bubble_tea'] }),
    drink({ name: '檸檬和茶（大杯）', calories: 170, protein_g: 1, carbs_g: 42, price: 52, tags: ['bubble_tea'] }),
  ],
  hecha: [
    drink({ name: '鶴茶樓招牌（大杯）', calories: 380, protein_g: 1, carbs_g: 58, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 400, protein_g: 1, carbs_g: 64, price: 55, tags: ['bubble_tea'] }),
    drink({ name: '翡翠檸檬（大杯）', calories: 175, protein_g: 1, carbs_g: 44, price: 52, tags: ['bubble_tea'] }),
    drink({ name: '四季春茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
  ],
  shuixiang: [
    drink({ name: '水巷紅茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 30, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 405, protein_g: 1, carbs_g: 65, price: 52, tags: ['bubble_tea'] }),
    drink({ name: '紅茶拿鐵（大杯）', calories: 290, protein_g: 1, carbs_g: 40, price: 60, tags: ['bubble_tea'] }),
    drink({ name: '檸檬紅茶（大杯）', calories: 180, protein_g: 1, carbs_g: 45, price: 50, tags: ['bubble_tea'] }),
  ],
  'sunrise-tea': [
    drink({ name: '日出紅茶（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 28, tags: ['bubble_tea'] }),
    drink({ name: '珍珠奶茶（大杯）', calories: 400, protein_g: 1, carbs_g: 64, price: 50, tags: ['bubble_tea'] }),
    drink({ name: '紅茶拿鐵（大杯）', calories: 280, protein_g: 1, carbs_g: 38, price: 58, tags: ['bubble_tea'] }),
    drink({ name: '翡翠檸檬（大杯）', calories: 170, protein_g: 1, carbs_g: 42, price: 50, tags: ['bubble_tea'] }),
  ],
}
