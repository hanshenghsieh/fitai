...
export const COFFEE_CATALOG: BrandCatalog = {
  starbucks: [
    drink({ name: '美式咖啡（中杯）', calories: 12, protein_g: 1, carbs_g: 1, price: 95, aliases: ['美式'], tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 152, protein_g: 1, carbs_g: 14, price: 120, fat_g: 8, aliases: ['latte'], tags: ['coffee'] }),
    drink({ name: '焦糖瑪奇朵（中杯）', calories: 264, protein_g: 1, carbs_g: 32, price: 135, sugar_g: 36, tags: ['coffee'] }),
    drink({ name: '冷萃咖啡（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 120, tags: ['coffee'] }),
  ...
  louisa: [
    ...
    drink({ name: '拿鐵（中杯）', calories: 170, protein_g: 12, carbs_g: 8, price: 85, tags: ['coffee'] }),
    drink({ name: '小農拿鐵（中杯）', calories: 190, protein_g: 14, carbs_g: 10, price: 95, tags: ['coffee'] }),
  ...
  '85c': [
    ...
    drink({ name: '拿鐵（中杯）', calories: 175, protein_g: 13, carbs_g: 8, price: 90, tags: ['coffee'] }),
    meal('起司蛋糕（切片）', 380, 6, 42, 16, 95, 'dinner', { role: 'side' }),
    meal('海苔肉鬆麵包', 320, 10, 38, 10, 45, 'breakfast'),
    meal('三明治（雞肉）', 340, 20, 34, 14, 65, 'breakfast'),
  ],
  cama: [
    drink({ name: '美式（中杯）', calories: 8, protein_g: 1, carbs_g: 1, price: 55, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 165, protein_g: 12, carbs_g: 8, price: 75, tags: ['coffee'] }),
    drink({ name: '黑糖拿鐵（中杯）', calories: 220, protein_g: 28, carbs_g: 10, price: 85, tags: ['coffee'] }),
