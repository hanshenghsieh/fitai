...
export const COFFEE_GAP_CATALOG: BrandCatalog = {
  'mr-brown': [
    drink({ name: '美式咖啡（中杯）', calories: 10, protein_g: 1, carbs_g: 1, price: 75, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 180, protein_g: 8, carbs_g: 14, price: 95, tags: ['coffee'] }),
    drink({ name: '卡布奇諾（中杯）', calories: 160, protein_g: 7, carbs_g: 12, price: 95, tags: ['coffee'] }),
    meal('雞肉三明治', 320, 20, 32, 12, 85, 'breakfast'),
    meal('起司貝果', 280, 10, 38, 8, 65, 'breakfast', { role: 'side' }),
  ],
  'cheng-zhen': [
    drink({ name: '美式咖啡（中杯）', calories: 10, protein_g: 1, carbs_g: 1, price: 80, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 175, protein_g: 8, carbs_g: 14, price: 100, tags: ['coffee'] }),
    drink({ name: '焦糖瑪奇朵（中杯）', calories: 250, protein_g: 8, carbs_g: 32, price: 120, tags: ['coffee'] }),
    meal('雞肉沙拉三明治', 340, 22, 32, 14, 95, 'breakfast'),
    meal('藍莓瑪芬', 380, 6, 52, 16, 65, 'breakfast', { role: 'side' }),
  ],
  'black-water': [
    drink({ name: '美式咖啡（中杯）', calories: 8, protein_g: 1, carbs_g: 1, price: 70, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 170, protein_g: 8, carbs_g: 12, price: 90, tags: ['coffee'] }),
    drink({ name: '手沖單品（中杯）', calories: 5, protein_g: 1, carbs_g: 1, price: 85, tags: ['coffee'] }),
  ...
  dante: [
    drink({ name: '美式咖啡（中杯）', calories: 10, protein_g: 1, carbs_g: 1, price: 75, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 180, protein_g: 8, carbs_g: 14, price: 95, tags: ['coffee'] }),
    drink({ name: '摩卡（中杯）', calories: 220, protein_g: 8, carbs_g: 28, price: 110, tags: ['coffee'] }),
    meal('雞肉三明治', 330, 20, 32, 12, 88, 'breakfast'),
    meal('提拉米蘇', 380, 6, 40, 20, 95, 'lunch', { role: 'side' }),
  ],
  donutes: [
    drink({ name: '美式咖啡（中杯）', calories: 10, protein_g: 1, carbs_g: 1, price: 70, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 175, protein_g: 8, carbs_g: 14, price: 90, tags: ['coffee'] }),
  ...
  cafein: [
    drink({ name: '美式咖啡（中杯）', calories: 8, protein_g: 1, carbs_g: 1, price: 65, tags: ['coffee'] }),
    drink({ name: '拿鐵（中杯）', calories: 165, protein_g: 8, carbs_g: 12, price: 85, tags: ['coffee'] }),
    drink({ name: '燕麥拿鐵（中杯）', calories: 190, protein_g: 8, carbs_g: 18, price: 95, tags: ['coffee'] }),
